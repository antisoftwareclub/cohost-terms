...
_last modified october 3, 2022_
...
- do not post content which is illegal in the United States, or use cohost to
  ...
  - we have a moral and legal obligation to detect and remove child sexual
    ...
    - for clarity of enforcement, and to match with existing legal
      definitions, we consider this to include realistic depictions of
      human minors (photographs/videos of actual human minors, or visual
      material which is difficult to distinguish from a real
      photograph/video).
    - our policy around depictions of obviously fictional human minors
      (i.e. lolicon/shotacon) has not been finalized, and we intend to set
      it with community input. we ask that, for the moment, you refrain
      from posting any such content.
...
support@cohost.org and we’ll do our best to help!
